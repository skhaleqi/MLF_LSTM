...
@tf.function
def HFLF(yTrue, yPred):
     sig = 0.1
     lam = 0.9
     print('training samples: ', yTrue.shape)
     print('testing samples: ', yPred.shape)
...
for i, act in enumerate(activations):
    ...
    cand.add(Dense(8))
    ############################
    cand.compile(loss=HFLF, optimizer=opt)#'Nadam'
